  ...
  elite_package: {
    ...
    data: [
      ...
      },
      {
        title: "Kitchen",
        items: [
          "Ceramic Wall Dado - Up to ₹90 per sq. ft., upto 3 ft. height",
          "Main Sink Faucet - Up to ₹4,500",
          "Other Faucets or Accessories – ISI Marked",
          "Kitchen Sink - Granite finish, upto ₹12,000 (Futura, Carysil)",
        ],
      },
      {
        title: "Bathroom",
      ...
      },
      {
        ...
        items: [
          "Wiring - ISI Standard Fire-proof wires – Finolex Silver FR or equivalent",
          "Switches & Sockets - Legrand Myrius, Schneider Unica Pure, or equivalent",
          "UPS Wiring Provision",
