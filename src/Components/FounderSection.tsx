...
const FounderSection = () => {
  return (
    <Section className="relative h-[100vh] !w-full !py-0">
      ...
      <div className="absolute z-10 flex flex-col items-start bottom-1/10 w-full max-w-[530px] left-10">
      <svg xmlns="http://www.w3.org/2000/svg" width="162" height="85" viewBox="0 0 162 85" fill="none">
        ...
        {/* Desktop Content */}
        <Title className="leading-[100%] text-left !text-[28px] sm:!text-[48px] capitalize font-biter font-bold mt-[] !mb-[90px]">
