...
export default function Header() {
    ...
    return (
        ...
        className={`bg-white p-4 ${mobileOpen ? 'h-[100dvh] mobileHeader !bg-black' : 'h-auto'
            ...
            <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                ...
                <div className="flex flex-col sm:flex-row md:items-baseline sm:items-start gap-4">
                    <h1 className="text-2xl font-bold tracking-tight flex items-center">
                        {/* Logo SVG */}
                        <Link href="/">
                        {mobileOpen ? (<svg width="168" height="33" viewBox="0 0 168 33" fill="none" xmlns="http://www.w3.org/2000/svg">
