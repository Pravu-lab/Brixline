                ...
                <div className="flex flex-col sm:flex-row md:items-baseline sm:items-start gap-4">
                    <h1 className="text-2xl font-bold tracking-tight flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="168" height="33" viewBox="0 0 168 33" fill="none">
                            ...
                            <path d="M160.554 0.0519829H161.832L164.042 5.45185H164.121L166.336 0.0519829H167.633V7H166.607V1.97318H166.542L164.485 6.99067H163.655L161.622 1.96852H161.557V7H160.554V0.0519829Z" fill="black" />
                            <path d="M154.399 0.951957V0.0519791H159.78V0.951957H157.616V7H156.572V0.951957H154.399Z" fill="black" />
                        </svg>
                    </h1>
