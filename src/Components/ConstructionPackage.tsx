...
const ConstructionCard: React.FC<ConstructionCardProps> = ({ packageDetails }) => {
  ...
  return (
    <div className="mt-6 w-full shadow-[0px_34px_64px_0px_#00000017] py-12 px-4 max-h-[728px] overflow-y-scroll bg-white min-w-[316px] sm:max-w-[316px]">
      <div className="sticky bg-white text-center top-0">
        <div className="text-black text-[40px] font-medium mb-4">
      ...
      {packageDetails.data.map((section, index) => {
        ...
        return (
          <div key={section.title} className="py-4 border-b border-[rgba(0,0,0,0.05)]">
            <div
