    ...
    return (
        <Section className="w-full md:w-[90%] mx-auto m-auto md:px-[5%]">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center py-4 gap-4 ">
                <Description className="text-black w-full md:w-1/2 md:p-4 py-48 md:py-10 md:mx-auto mx-auto">
                ...
                <Image
                    ...
                    width={700}
                    height={700}
                    className="max-w-[122px] w-full h-fit mx-auto my-auto"
                />
            </div>
                ...
                {text.split(" ").map((word, wordIndex) => (
                    <div key={wordIndex} className="whitespace-nowrap flex">
                        {word.split("").map((char, charIndex) => {
                            ...
                            return (
                                <motion.h1 className="text-black text-[32px] md:text-[72px]/[120%] font-extralight tracking-[-4px]" key={index} style={{ opacity }}>
                                    {char}
                                </motion.h1>
                            );
                        })}
