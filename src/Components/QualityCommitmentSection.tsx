...
const servicesBlock = [
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M15.4667 13.3335V18.6668H20.8"
          stroke="#F55252"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M15.4667 18.6665L17.5133 16.5265C18.2787 15.7909 19.2087 15.2487 20.2259 14.9451C21.2431 14.6414 22.3181 14.5851 23.3615 14.7807C24.4049 14.9763 25.3865 15.4183 26.2246 16.0698C27.0627 16.7214 27.7331 17.5636 28.18 18.5265"
          stroke="#F55252"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M28.8 24L26.7533 26.14C25.988 26.8756 25.058 27.4178 24.0408 27.7214C23.0236 28.0251 21.9485 28.0815 20.9052 27.8858C19.8618 27.6902 18.8802 27.2482 18.0421 26.5967C17.204 25.9452 16.5336 25.1029 16.0867 24.14"
          stroke="#F55252"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M16.2 29.3332C23.5638 29.3332 29.5333 23.3636 29.5333 15.9998C29.5333 8.63604 23.5638 2.6665 16.2 2.6665C8.83617 2.6665 2.86664 8.63604 2.86664 15.9998C2.86664 23.3636 8.83617 29.3332 16.2 29.3332Z"
          stroke="#F55252"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M14 16.6667C18.4447 16.6667 18.4447 10 14 10"
          stroke="#F55252"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    icon: (
      ...
      >
        ...
        />
        <path
          d="M16.6 18.6665C21.0183 18.6665 24.6 15.0848 24.6 10.6665C24.6 6.24823 21.0183 2.6665 16.6 2.6665C12.1817 2.6665 8.59998 6.24823 8.59998 10.6665C8.59998 15.0848 12.1817 18.6665 16.6 18.6665Z"
          stroke="#F55252"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  return (
    <>
      <Section className="bg-black text-white py-20 px-6 flex flex-col items-center gap-16 !w-full ">
        ...
        {/* Features Row */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 text-center w-full max-w-6xl mb-22 md:mb-40">
          {servicesBlock.map((item, i) => (
            <div
              key={i}
              className={`flex flex-col items-start px-0 md:px-4 py-6 
              ${i !== 4 ? "lg:border-r" : ""} 
              ${i % 2 === 0 && i < 2 ? "sm:border-r" : ""}
              border-white/10`}
            >
              {item.icon}
              <h4 className="text-white font-semibold text-sm mt-4 text-left ">
                {item.title}
              </h4>
              <Description className="text-white opacity-70 mt-1 text-left">
                {item.desc}
              </Description>
            </div>
          ))}
      ...
      <Section className="!py-0">
        <div className="bg-[#F55252] m-auto text-white w-full max-w-6xl flex mt-[-125px] flex-col sm:flex-row">
          <div className="grid grid-cols-2 gap-0 rounded-xl w-full">
            <div className="text-left py-7 pl-5 md:pl-15 grid md:w-[210px] lg:w-[230px] xl:w-[290px] border-r border-white/20">
              <h3 className="text-3xl font-bold">3.6L</h3>
              <p className="text-sm mt-1">SQ. FT. DELIVERED</p>
            </div>
            <div className="text-left py-7 pl-5 md:pl-0 w-inherit md:w-[250px]">
