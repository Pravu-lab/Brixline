  ...
  return (
    <div className={`relative w-full flex justify-end ${classname}`}>
      <div className="max-w-[390px] relative max-h-[562px]">
        <div className=" absolute px-7 pt-[50px] md:pt-[72px] z-20">
        ...
        <svg
          ...
          fill="none"
        >
          <foreignObject x="-74" y="-74" width="538" height="714">
            <div
              style={{
          ...
          <g data-figma-bg-blur-radius="74">
            <path
              d="M0 566H390V64L307.5 0H0V566Z"
              fill="black"
              fillOpacity="0.8"
            />
            <path
            ...
            />
            <path
              d="M307.328 0.5L389.5 64.2451V565.5H0.5V0.5H307.328Z"
              stroke="white"
              strokeOpacity="0.2"
            />
          </g>
          <defs>
            <clipPath
              id="bgblur_0_244_270_clip_path"
              transform="translate(74 74)"
            >
              <path d="M0 566H390V64L307.5 0H0V566Z" />
            </clipPath>
          </defs>
        </svg>
      </div>
